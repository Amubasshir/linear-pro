...
export const Header = () => {
  ...
  const closeMenu = () => setHamburgerMenuIsOpen((open) => !open);
      ...
      <Container className="flex h-navigation-height">
        ...
        >
          ...
          >
            <ul
              className={classNames(
                'flex h-full flex-col md:flex-row md:items-center [&_li]:ml-6 md:[&_li]:border-b [&_li]:border-grey-dark md:[&_li]:border-none',
